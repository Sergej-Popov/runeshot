...
export const runeEl = requiredById<HTMLElement>("rune");
...
export const serverDebugEl = requiredById<HTMLElement>("serverDebug");
export const serverDebugStateEl = requiredById<HTMLElement>("serverDebugState");
export const serverDebugAuthEl = requiredById<HTMLElement>("serverDebugAuth");
export const serverDebugLobbyEl = requiredById<HTMLElement>("serverDebugLobby");
export const serverDebugRoomEl = requiredById<HTMLElement>("serverDebugRoom");
export const serverDebugPlayersEl = requiredById<HTMLElement>("serverDebugPlayers");
export const serverDebugUrlEl = requiredById<HTMLElement>("serverDebugUrl");
export const potionBeltEl = requiredById<HTMLElement>("potionBelt");
export const potionSlotEls = Array.from(potionBeltEl.querySelectorAll<HTMLElement>(".potion-slot"));
export const potionCountEls = Array.from(potionBeltEl.querySelectorAll<HTMLElement>(".potion-count"));
export const speedCooldownEl = requiredById<HTMLElement>("speedCooldown");
